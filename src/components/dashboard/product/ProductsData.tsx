  ...
  return (
    <div className="rounded-sm border border-stroke w-full bg-gray-900 px-5 shadow-default dark:bg-boxdark sm:px-7">
      <div className="py-6  flex flex-wrap items-center justify-between">
        ...
        <Link to="/admin/add-product" className="text-sm font-medium text-white bg-blue-600 py-2 px-4 rounded-full hover:opacity-90">Tambah Data</Link>
      </div>
            ...
            <tr>
              ...
              <td className="px-4 py-2">
                <div className="flex items-center space-x-3">
                  <button className="hover:opacity-70 text-sm text-white rounded-full px-1 bg-yellow-500 flex justify-center items-center gap-1"><FaEdit /> Edit</button>
                  <button className="hover:opacity-70 text-sm text-white rounded-full px-1 bg-red-500 flex justify-center items-center gap-1"><FaTrash /> Hapus</button>
                </div>
              </td>
            </tr>
            <tr>
