  ...
  return (
    <div className="min-h-[100vh] bg-[#dddddd] rounded-t-[40px] py-10 -my-20 z-10 relative">
      <Section className="flex flex-col gap-3">
        ...
        <div className={`grid py-3 max-sm:grid-cols-2 max-lg:grid-cols-3 max-2xl:grid-cols-4 grid-cols-5 max-sm:gap-3 gap-5 h-max items-start justify-center ${products?.data?.length as number <= 2 && "max-h-80"}`}>
